...
ActiveRecord::Schema.define(version: 20180116043932) do
  ...
  create_table "video_likes", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "video_id", null: false
    t.integer "user_id", null: false
  ...
  create_table "videos", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.text "description"
    t.integer "user_id", null: false
    t.index ["user_id", "video"], name: "index_videos_on_user_id_and_video", unique: true
  end
